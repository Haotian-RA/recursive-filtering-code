...
template<typename T, int N> class Filter{ 
    ...
    public:
        ...
        // filter system filtering scalar 
        template<typename InputIt, typename OutputIt> inline OutputIt cascaded_scalar(InputIt first, OutputIt last, OutputIt d_first){
